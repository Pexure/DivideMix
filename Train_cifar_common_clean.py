...
stats_log=open('./checkpoint/common_clean_%s_%.1f_%s'%(args.dataset,args.r,args.noise_mode)+'_stats.txt','a')
test_log=open('./checkpoint/common_clean_%s_%.1f_%s'%(args.dataset,args.r,args.noise_mode)+'_acc.txt','a')
