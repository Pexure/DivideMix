...
stats_log=open('./checkpoint/diffgs0.2_%s_%.1f_%s'%(args.dataset,args.r,args.noise_mode)+'_stats.txt','a')
test_log=open('./checkpoint/diffgs0.2_%s_%.1f_%s'%(args.dataset,args.r,args.noise_mode)+'_acc.txt','a')
...
for epoch in range(warm_up, args.num_epochs+1):
    ...
    pred1 = (prob1 > args.p_threshold + 0.2)
