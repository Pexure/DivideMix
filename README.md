...
```
python Train_cifar.py --r 0.9 --lambda_u 50 --data_path ./data/cifar-10-batches-py
python Train_cifar_single.py --r 0.9 --lambda_u 50 --data_path ./data/cifar-10-batches-py
```
